...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active"
             style="height: 900px;
                     background: url('/resources/images/showpieces/${showpieces[0].imageUrl}') no-repeat;
        ...
        <div class="item"
             style="height: 900px;
                     background: url('/resources/images/showpieces/${showpieces[1].imageUrl}') no-repeat;
                     background-size:cover;
                     filter: grayscale(80%);">
            <div class="carousel-caption">
        ...
        <div class="item"
             style="height: 900px;
                     background: url('/resources/images/showpieces/${showpieces[2].imageUrl}') no-repeat;
                     background-size:cover;
                     filter: grayscale(80%);">
            ...
            <c:forEach items="${upcomingEvents}" var="event">
                <div class="col-sm-4">
                    <div class="thumbnail  indexExcursion">
                        <img src="/resources/images/excursions/${event.excursion.imageUrl}" alt="Paris" width="400"
                             height="500">
                        <p><strong>${event.excursion.name}</strong></p>
                        <p>${event.startTime}</p>
                        <a href="/excursion/${event.excursion.id}">
                            <button class="btn"><spring:message code="visit"/></button>
                        </a>
                    </div>
                </div>
            </c:forEach>
