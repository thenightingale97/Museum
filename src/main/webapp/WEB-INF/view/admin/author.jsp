...
<div class="row">
    <div class="col-md-7 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-3"><h3><spring:message code="authorName"/></h3></div>
            <div class="col-md-2"><h3><spring:message code="update"/></h3></div>
            <div class="col-md-2"><h3><spring:message code="delete"/></h3></div>
        </div>
        <c:forEach items="${authors}" var="author">
            <div class="row">
                <div class="col-md-3">${author.firstName} ${author.lastName}</div>
                <div class="col-md-2"><a class="btn btn-warning" href="author/updating/${author.id}"><spring:message
                        code="update"/></a></div>
                <div class="col-md-2"><a class="btn btn-danger" href="author/delete/${author.id}"><spring:message
                        code="delete"/></a></div>
            </div>
        </c:forEach>
    </div>
