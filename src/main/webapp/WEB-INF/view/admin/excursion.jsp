...
<div class="row">
    <div class="col-md-7 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-md-2"><h3><spring:message code="duration"/></h3></div>
            <div class="col-md-3"><h3><spring:message code="maxVisitorAmount"/></h3></div>
        ...
        <c:forEach items="${excursions}" var="excursion">
            <div class="row">
                <div class="col-md-3">${excursion.name}</div>
                <div class="col-md-2">${excursion.duration}</div>
                <div class="col-md-3">${excursion.maxVisitorAmount}</div>
                <div class="col-md-2"><a class="btn btn-warning"
                                         href="excursion/updating/${excursion.id}"><spring:message code="update"/></a>
                </div>
                <div class="col-md-2"><a class="btn btn-danger" href="excursion/delete/${excursion.id}"><spring:message
                        code="delete"/></a></div>
            </div>
        </c:forEach>
